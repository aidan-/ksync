...
func (a *Applier) prepareSyncWaves(localInv inventory.Info, localObjs object.UnstructuredSet,
	o ApplierOptions) ([]syncWave, error) {
	if localInv == nil {
...
func (a *Applier) prepareObjects(
	...
	o ApplierOptions,
) (object.UnstructuredSet, object.UnstructuredSet, error) {
	if localInv == nil {
...
func (a *Applier) runWave(ctx context.Context, invInfo inventory.Info, objects object.UnstructuredSet, options ApplierOptions) <-chan event.Event {
...
func (a *Applier) Run(ctx context.Context, invInfo inventory.Info, objects object.UnstructuredSet, options ApplierOptions) <-chan event.Event {
	...
	go func() {
		...
		// TODO(aidan): calculate the sync waves here

		// TODO(aidan): loop through sync waves here

		// TODO(aidan): emit events for sync waves
